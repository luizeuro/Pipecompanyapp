// Acesso ao banco. Em produção é sempre o Supabase (service role, só no
// backend). Rodando local sem SUPABASE_URL, cai num banco em memória com
// dados de demonstração — assim dá pra mexer na interface sem credencial nenhuma.
