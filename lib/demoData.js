...
export function buildDemoData() {
  ...
  // Relatórios de demonstração: um publicado pelo agente e um resumo diário geral.
  const reports = [
    {
      client_id: c.sorriso,
      kind: 'report',
      title: 'Relatório semanal · Clínica Sorriso',
      content:
        '## Resumo da semana\n\n- **Meta Ads:** 63 conversas no WhatsApp, custo de **R$ 13,33** por conversa (semana anterior: R$ 15,10).\n- **Google Ads:** 18,5 conversões, R$ 22,70 cada.\n\n## O que chama atenção\n\n1. Saldo do Google acaba em ~5 dias: combinar recarga com a Dra. Paula.\n2. Sem otimização há 17 dias.\n\n## Próximos passos\n\n- Testar o vídeo novo de implante.\n- Enviar este relatório pelo WhatsApp.',
      period_start: dateOnly(-7),
      period_end: dateOnly(-1),
      created_by: 'Hermes (agente)',
    ...
    },
    {
      ...
      kind: 'daily',
      title: 'Resumo do dia',
      content: '**4 atrasados**, 2 para hoje.\n\n- Em risco: Loja de Ferramentas (sem contato há 32 dias).\n- Saldo acabando: Imobiliária Litoral (~2 dias).',
      created_by: 'Hermes (agente)',
      created_at: daysAgo(0, 8),
    },
  ]

  return { clients, account_snapshots, optimizations, pendencias, alerts, app_state, contacts, interactions, leads, reports }
}
